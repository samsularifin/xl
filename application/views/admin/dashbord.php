...
?>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
		  ...
		  <div class="marquee"><marquee>Selamat datang di halaman Administrator XL Center Surabaya	</marquee></div>
			<div class="container">
				<span class="home-link"><a href="index.html" class="icon-home"></a></span><a class="brand" href="./index.html"><img src="<?php echo base_url();?>assets/images/xllogo.png" class="admin_logo" alt="XL"></a>
				...
				<div class="span12">
					<div class="content-widgets gray">
						<div class="widget-head bondi-blue">
							<h3><i class="icon-ambulance"></i>Halaman admin</h3>
						</div>
