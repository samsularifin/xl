...
<div class="primary-head">
						<h3 class="page-header">COMPARE PAGE</h3>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
							<form class="form-horizontal" method="POST" action="<?php echo base_url();?>internal/compare/" name="formsearch" id="form">
											...
											<?php
													if(!empty($this->input->post('level'))){
														if($getlevel == $data->nama_level){
															echo "selected='selected' onselect='changeFunc()'";
														}
													}
												?>>
								...
								<div class="form-actions">
									<div class="icon-upload_lagi left-addon">
										...
										<input type="submit" name="search" class="btn btn btn-primary" value="Search Growth" id="comparegrowh"></input>
...
$(function() {
	$("#comparegrowh").click(function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>internal/compare/ajaxsubmit/",
			data:  $('#form').serialize(),
...
// code for IE6, IE5 
	...
	function changeFunc() {
		...
		if(selectedValue == "Tower_ID_adj"){
			xmlhttp.open("POST","<?php echo base_url();?>internal/compare/showtowerid",false);		
			xmlhttp.send(null); 
