		...
		<div class="span12">
			...
			<div class="content-widgets white">
				...
				<div class="widget-container">
					<?php
						$tempor = 0;
						foreach($grcluster as $v2){
					?>
					<div id="ctrend<?php echo $tempor;?>" style="height:400px"></div>
					<?php
							$tempor++;
						}
					?>
...
<?php
	$tempe = 0;
	foreach($grcluster as $vv){
?>
<script type="text/javascript">
$(function () {
    $('#ctrend<?php echo $tempe;?>').highcharts({
        chart: {
            type:'column',
            margin: 75,
            options3d: {
        ...
        title: {
            text: 'Revenue <?php echo month($gfm).", ". $gfy." VS ". month($glm).", ". $gly;?>',
			style: {
                    fontSize: '18px',
...
$(function () {
    $('#chart').highcharts({
        ...
        title: {
            text: 'Total Revenue <?php echo month($gfm).", ". $gfy." VS ". month($glm).", ". $gly;?>',
			style: {
                    fontSize: '18px',
                    fontFamily: 'Verdana, sans-serif'
            }
...
$(function () {
    $('#chart2').highcharts({
        ...
        title: {
            text: 'Voice Revenue <?php echo month($gfm).", ". $gfy." VS ". month($glm).", ". $gly;?>',
			style: {
                    fontSize: '12px',
                    fontFamily: 'Verdana, sans-serif'
            }
...
$(function () {
    $('#chartsms').highcharts({
        ...
        title: {
            text: 'SMS Revenue <?php echo month($gfm).", ". $gfy." VS ". month($glm).", ". $gly;?>',
			style: {
                    fontSize: '18px',
                    fontFamily: 'Verdana, sans-serif'
            }
...
$(function () {
    $('#chart4').highcharts({
        ...
        title: {
            text: 'Other Revenue <?php echo month($gfm).", ". $gfy." VS ". month($glm).", ". $gly;?>',
			style: {
                    fontSize: '18px',
                    fontFamily: 'Verdana, sans-serif'
            }
...
$(function () {
    $('#chart5').highcharts({
        ...
        title: {
            text: 'Data Revenue <?php echo month($gfm).", ". $gfy." VS ". month($glm).", ". $gly;?>',
			style: {
                    fontSize: '18px',
                    fontFamily: 'Verdana, sans-serif'
            }
