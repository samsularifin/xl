											...
											<tr>
												...
												<?php
													...
													foreach ($second_query as $frow){
														...
														if($counter > 0){
															if($indatatype == 'AVG'){
																$gtotal =  ($temp[$counter][0]->voice - $temp[$counter - 1][0]->voice)  / ($temp[$counter -1][0]->voice) * 100;
															}else{
																$gtotal =  ($temp[$counter][0]->voice/substr($temp[$counter][0]->Period, 0,-6) - $temp[$counter - 1][0]->voice / substr($temp[$counter - 1][0]->Period, 0,-6))  / ($temp[$counter -1][0]->voice/substr($temp[$counter -1][0]->Period, 0,-6)) * 100;
															}
