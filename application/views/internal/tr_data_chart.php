											...
											<tr>
												...
												<?php
													...
													foreach ($second_query as $frow){
														...
														if($counter > 0){
															if($indatatype == 'AVG'){
																$gtotal =  ($temp[$counter][0]->data - $temp[$counter - 1][0]->data) / ($temp[$counter -1][0]->data) * 100;
															}else{
																$gtotal =  ($temp[$counter][0]->data/substr($temp[$counter][0]->Period, 0,-6) - $temp[$counter - 1][0]->data / substr($temp[$counter - 1][0]->Period, 0,-6))  / ($temp[$counter -1][0]->data/substr($temp[$counter -1][0]->Period, 0,-6)) * 100;
															}
