													...
													<?php
														...
														foreach ($second_query as $frow){
															...
															if($counter > 0){
																	...
																	$gtotal =  ($temp[$counter][0]->ssms/substr($temp[$counter][0]->pperiod, 0,-6) - $temp[$counter - 1][0]->ssms / substr($temp[$counter - 1][0]->pperiod, 0,-6))  / ($temp[$counter -1][0]->ssms/substr($temp[$counter -1][0]->pperiod, 0,-6)) * 100;
